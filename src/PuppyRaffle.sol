...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //@audit - Gas (vars should be constant)
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        //@audit DOS
        //@audit - Gas (cached length -> uint256 playersLength = players.length)
    ...
    function refund(uint256 playerIndex) public {
        ...
        //@audit reentrancy
        //making an external call before we update the state
